...
const MyBookingPage = async ({ bookings }) => {
  ...
  return (
    <div className="container mx-auto">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-blue-600">My Bookings</h1>
      ...
      <div className="overflow-x-auto bg-base-100 rounded-sm shadow-xl border border-base-300">
        <table className="table">
          <thead className="bg-blue-600 text-white">
            <tr>
              <th className="rounded-tl-sm">Room</th>

              <th>Booking Date</th>

              <th className="hide_in_mobile">Time</th>

              <th className="hide_in_mobile">Total Cost</th>

              <th className="hide_in_mobile">Status</th>

              <th className="hide_in_mobile">Note</th>

              <th className="rounded-tr-sm text-right">Action</th>
            </tr>
          </thead>
          ...
          <tbody>
            {bookings.map(async (booking) => {
              const res = await fetch(
                `${process.env.NEXT_PUBLIC_BACKEND_URI}/room/${booking.room_id}`,
              );
              ...
              const canCancel = booking.booking_date >= today;
                ...
                >
                  <td>
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 text-sm">Room Booking</p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="text-left">
                    {canCancel ? (
                      ...
                      <button disabled className="btn btn-disabled rounded-xl">
                        Expired
                      </button>
                    )}
                  </td>
